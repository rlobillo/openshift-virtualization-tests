...
from tests.storage.restricted_namespace_cloning.constants import PVC, TARGET_DV
from tests.storage.utils import assert_pvc_snapshot_annotation
...
def verify_snapshot_used_namespace_transfer(
    cdv: DataVolume, unprivileged_client: DynamicClient
) -> None:
