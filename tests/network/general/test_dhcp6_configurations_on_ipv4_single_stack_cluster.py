...
@pytest.fixture(scope="module")
def skip_if_not_ipv4_single_stack_cluster(
...
@pytest.fixture()
def listening_dhcpv6_pid_in_virt_launcher_pod(
    worker_node1_pod_executor, virt_launcher_pid
):
    """
...
def test_dhcp6_disabled_on_ipv4_single_stack_cluster(
    ...
    assert (
        not listening_dhcpv6_pid_in_virt_launcher_pod
    ), "DHCPv6 is not disabled on this IPv4-single-stack cluster!"
