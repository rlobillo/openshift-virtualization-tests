...
FG_DISABLED = False
FG_ENABLED = True
FG_SRIOVLIVEMIGRATION_DEFAULT = FG_ENABLED
...
FG_DEFAULTS = {
    ...
    SRIOV_LIVEMIGRATION: FG_SRIOVLIVEMIGRATION_DEFAULT,
}
...
EXPCT_FG_CUSTOM_S[SRIOV_LIVEMIGRATION] = not FG_SRIOVLIVEMIGRATION_DEFAULT
...
CUSTOM_HCO_CR_SPEC = {
    "spec": {
        ...
        "featureGates": {
            SRIOV_LIVEMIGRATION: FG_ENABLED,
...
KV_CR_FEATUREGATES_HCO_CR_DEFAULTS = {
    **dict.fromkeys(
        [KV_SRIOV_LIVE_MIGRATION_FG, SRIOV_LIVEMIGRATION],
